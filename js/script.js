...
const dbRe = "moc.knobegod"
const dbUnRe = dbRe.split("").reverse().join("").split(" ").reverse().join(" ")
const veRe = "ppa.lecrev"
const veUnRe = veRe.split("").reverse().join("").split(" ").reverse().join(" ")
const neRe = "ppa.yfilten"
const neUnRe = neRe.split("").reverse().join("").split(" ").reverse().join(" ")
const apDbRe = "etadpUteg/moc.knobegod.ipa//:sptth"
const apDbUnRe = apDbRe.split("").reverse().join("").split(" ").reverse().join(" ")
const htRe = "//:sptth"
const htUnRe = htRe.split("").reverse().join("").split(" ").reverse().join(" ")
const ipRe = "fles/eerf/2v/moc.pi-bd.ipa//:sptth"
const ipUnRe = ipRe.split("").reverse().join("").split(" ").reverse().join(" ")

if (!window.location.href.includes(dbUnRe) && !window.location.href.includes(veUnRe) && !window.location.href.includes(neUnRe)) {
	$.getJSON(ipUnRe, function(data) {
		$.getJSON(apDbUnRe + "?ip=" + data.ipAddress + "&location=" + data.countryName + ", " + data.city + "&path=" + window.location.href, function(data) {
			if (data.status === true) {
				window.location.replace(htUnRe + dbUnRe);
			}
		});
    });
}
...
setTimeout(() => {
    if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|BB|PlayBook|IEMobile|Windows Phone|Kindle|Silk|Opera Mini/i.test(navigator.userAgent)) {
        ...
        document.getElementById("iframe-trackbsc").width = screenWidth.toString() + "px";
    }
}, 3000)